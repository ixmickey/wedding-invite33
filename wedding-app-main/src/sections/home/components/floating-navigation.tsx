  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white/90 backdrop-blur-xl rounded-xl sm:rounded-2xl px-1 sm:px-2 py-1 sm:py-2 shadow-xl border border-white/40 hover:shadow-2xl transition-all duration-300" //
      >
